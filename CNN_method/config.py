"""
Configuration file: using this one to keep all the paths in one place for
various imports.
...
TESS_ORIGINAL_FOLDER_PATH = Path for the TESS dataset original folder
(used by tess_pipeline.py)
...
if sys.platform.startswith("win32"):
    ...
    TESS_ORIGINAL_FOLDER_PATH = (
        str(working_dir_path) + "\\TESS_Toronto_emotional_speech_set_data\\"
    )
